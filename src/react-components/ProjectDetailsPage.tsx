...
import { ProjectDetailsCard, ProjectDetailsToDoList, ThreeJSViewer, ProjectSelector, ToeBimGrid } from '../react-components';
...
import { setupComponents  } from "../bim-components/setup/index"
...
export function ProjectDetailsPage({ projectsManager, onProjectCreate, onProjectUpdate, onToDoIssueCreated, onToDoIssueUpdated,onToDoIssueDeleted }: Props) {
    ...
    const setupGrid = async () => {
        ...
        console.log("ProjectDetailsPage: setupGrid llamado. Elemento Grid:", grid);
        if (!grid) return;
        ...
        grid.layout = "Main";
        console.log("ProjectDetailsPage: Configuración del grid finalizada. Layout establecido a 'Main'.");
    }



    React.useEffect(() => {
        console.log("ProjectDetailsPage: useEffect para setupGrid disparado.");
        setupGrid();
    }, [])
